...
if !fileexists("`analysis_data'") {
    ...
    else if fileexists("`processed_dir'/main_data.dta") {
        local analysis_data "`processed_dir'/main_data.dta"
    }
    else if fileexists("`project_root'/data/new_dta.dta") {
        local analysis_data "`project_root'/data/new_dta.dta"
    }
    else if fileexists("`project_root'/data/main_data.dta") {
        local analysis_data "`project_root'/data/main_data.dta"
    }
}
